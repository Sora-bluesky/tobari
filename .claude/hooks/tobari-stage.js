 ...
 *
 * Usage (CLI):
 *   node tobari-stage.js advance TASK-082 STG1
 *   node tobari-stage.js check   TASK-082 STG2   // dry-run
 *   node tobari-stage.js summary TASK-082
 *   node tobari-stage.js next    TASK-082
 *
 * Usage (library):
 *   const { advanceGate, checkDod, getStageSummary } = require("./tobari-stage.js");
 *   const result = advanceGate("TASK-082", "STG1");
 */
 ...
 *
 * Preserves YAML formatting (quotes, indentation) for task sync script
 * compatibility.
 *
 * Algorithm:
